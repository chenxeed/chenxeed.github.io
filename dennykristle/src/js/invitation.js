function Invitation(cb){
  ...
  $.ajax('https://spreadsheets.google.com/feeds/list/1daS_YGH22eiWLYPmdyAD5U-gFyHEiXyoJ6FXpvRG3oU/1/public/values?alt=json')
  ...
  function getURLFromPassword(password){
    return window.location.origin+'/dennykristle/index.html?o='+password;
  }
